...
#
# Generated by Vivado on Thu Mar 20 14:54:42 EDT 2025
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/cons/base.xdc"]"\
  ...
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/ip_repo/dac_nco_freq_controller_1_0"]"]"\
  ]
  foreach ipath $paths {
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/ip_repo/dac_nco_freq_controller_1_0"]" $obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  user.org:user:dac_nco_freq_controller:1.0\
  "
...
\
  ...
  set_property -dict [list \
    ...
    CONFIG.mDAC_Outclk_Freq {107.520} \
    CONFIG.mDAC_PLL_Enable {true} \
    CONFIG.mDAC_Refclk_Freq {491.520} \
    CONFIG.mDAC_Sampling_Rate {6.88128} \
  ...
  # Create instance: dac_nco_freq_control_0, and set properties
  set dac_nco_freq_control_0 [ create_bd_cell -type ip -vlnv user.org:user:dac_nco_freq_controller:1.0 dac_nco_freq_control_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins dac_nco_freq_control_0/S00_AXIS]
  ...
  connect_bd_net -net dac_nco_freq_control_0_m00_axis_tdata [get_bd_pins dac_nco_freq_control_0/m00_axis_tdata] [get_bd_pins usp_rf_data_converter_0/dac00_nco_freq]
  connect_bd_net -net dac_nco_freq_control_0_m00_axis_tstrb [get_bd_pins dac_nco_freq_control_0/m00_axis_tstrb] [get_bd_pins usp_rf_data_converter_0/dac00_nco_update_en]
  connect_bd_net -net dac_nco_freq_control_0_m00_axis_tvalid [get_bd_pins dac_nco_freq_control_0/m00_axis_tvalid] [get_bd_pins usp_rf_data_converter_0/dac0_nco_update_req]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins dac_nco_freq_control_0/s00_axis_aresetn]
  ...
  connect_bd_net -net usp_rf_data_converter_0_dac0_nco_update_busy [get_bd_pins usp_rf_data_converter_0/dac0_nco_update_busy] [get_bd_pins dac_nco_freq_control_0/m00_axis_tready]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins dac_nco_freq_control_0/s00_axis_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.917453",
   "Default View_TopLeft":"-175,0",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.7.1 2023-07-26 3bc4126617 VDI=43 GEI=38 GUI=JA:21.0 TLS
#  -string -flagsOSRD
preplace port sysref_in -pg 1 -lvl 0 -x 0 -y 180 -defaultsOSRD
preplace port dac0_clk -pg 1 -lvl 0 -x 0 -y 150 -defaultsOSRD
preplace port vout00 -pg 1 -lvl 5 -x 1860 -y 240 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 330 -y 540 -defaultsOSRD
preplace inst usp_rf_data_converter_0 -pg 1 -lvl 3 -x 1240 -y 260 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 3 -x 1240 -y 630 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 2 -x 830 -y 340 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 2 -x 830 -y 590 -defaultsOSRD
preplace inst rst_ps8_0_99M -pg 1 -lvl 1 -x 330 -y 750 -defaultsOSRD
preplace inst dac_nco_freq_control_0 -pg 1 -lvl 4 -x 1640 -y 140 -defaultsOSRD
preplace netloc usp_rf_data_converter_0_clk_dac0 1 1 3 650 230 1030 470 1410
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 2 1 N 380
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 4 20 640 650 730 1040 500 1450J
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 2 30 650 630
preplace netloc rst_ps8_0_99M_peripheral_aresetn 1 1 3 640 240 1010 510 1470J
preplace netloc dac_nco_freq_control_0_m00_axis_tdata 1 2 3 1070 10 NJ 10 1810
preplace netloc dac_nco_freq_control_0_m00_axis_tstrb 1 2 3 1050 460 1420J 20 1820
preplace netloc usp_rf_data_converter_0_dac0_nco_update_busy 1 2 3 1060 490 1440J 40 1840
preplace netloc dac_nco_freq_control_0_m00_axis_tvalid 1 2 3 1070 480 1430J 30 1830
preplace netloc sysref_in_1 1 0 3 NJ 180 NJ 180 NJ
preplace netloc dac0_clk_1 1 0 3 NJ 150 NJ 150 1030J
preplace netloc usp_rf_data_converter_0_vout00 1 3 2 NJ 240 NJ
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 1 1 N 510
preplace netloc ps8_0_axi_periph_M00_AXI 1 2 1 N 580
preplace netloc ps8_0_axi_periph_M01_AXI 1 2 1 1020 120n
preplace netloc axi_dma_0_M_AXIS_MM2S 1 3 1 1460 100n
levelinfo -pg 1 0 330 830 1240 1640 1860
pagesize -pg 1 -db -bbox -sgen -110 0 1960 850
"
}
