...
#
# rebuild.tcl: Tcl script for re-creating project '62410_bec'
#
# Generated by Vivado on Thu May 08 13:38:09 EDT 2025
...
#
#    "/home/andiqu/62410_bec/62410_bec/62410_bec/62410_bec.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/andiqu/62410_bec/62410_bec/cons/base.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/62410_bec/62410_bec.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
 ...
 "[file normalize "$origin_dir/cons/base.xdc"]"\
  ...
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/ip_repo/frequency_hopper_1_0"]"]"\
  ]
  foreach ipath $paths {
...
set orig_proj_dir "[file normalize "$origin_dir/62410_bec"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/ip_repo/frequency_hopper_1_0"]" $obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  user.org:user:frequency_hopper:1.0\
  "
...
\
    ...
    CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {149.999969} \
...
\
  ...
  set_property -dict [list \
    ...
    CONFIG.DAC0_Clock_Dist {2} \
    CONFIG.DAC0_Outclk_Freq {107.520} \
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins ps8_0_axi_periph/M01_AXI] [get_bd_intf_pins frequency_hopper_0/S00_AXI]
  ...
  connect_bd_net -net frequency_hopper_0_amplitude_tdata [get_bd_pins frequency_hopper_0/amplitude_tdata] [get_bd_pins usp_rf_data_converter_0/s00_axis_tdata]
  connect_bd_net -net frequency_hopper_0_amplitude_tvalid [get_bd_pins frequency_hopper_0/amplitude_tvalid] [get_bd_pins usp_rf_data_converter_0/s00_axis_tvalid]
  connect_bd_net -net frequency_hopper_0_led [get_bd_pins frequency_hopper_0/led] [get_bd_ports led]
  connect_bd_net -net frequency_hopper_0_nco_freq [get_bd_pins frequency_hopper_0/nco_freq] [get_bd_pins usp_rf_data_converter_0/dac00_nco_freq]
  connect_bd_net -net frequency_hopper_0_nco_phase [get_bd_pins frequency_hopper_0/nco_phase] [get_bd_pins usp_rf_data_converter_0/dac00_nco_phase]
  connect_bd_net -net frequency_hopper_0_nco_phase_rst [get_bd_pins frequency_hopper_0/nco_phase_rst] [get_bd_pins usp_rf_data_converter_0/dac00_nco_phase_rst]
  connect_bd_net -net frequency_hopper_0_nco_update_en [get_bd_pins frequency_hopper_0/nco_update_en] [get_bd_pins usp_rf_data_converter_0/dac00_nco_update_en]
  connect_bd_net -net frequency_hopper_0_nco_update_req [get_bd_pins frequency_hopper_0/nco_update_req] [get_bd_pins usp_rf_data_converter_0/dac0_nco_update_req]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0/s0_axis_aresetn]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins frequency_hopper_0/s00_axi_aresetn]
  connect_bd_net -net sw_1 [get_bd_ports sw] [get_bd_pins frequency_hopper_0/sw]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac0 [get_bd_pins usp_rf_data_converter_0/clk_dac0] [get_bd_pins usp_rf_data_converter_0/s0_axis_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net usp_rf_data_converter_0_dac0_nco_update_busy [get_bd_pins usp_rf_data_converter_0/dac0_nco_update_busy] [get_bd_pins frequency_hopper_0/nco_update_busy]
  connect_bd_net -net usp_rf_data_converter_0_s00_axis_tready [get_bd_pins usp_rf_data_converter_0/s00_axis_tready] [get_bd_pins frequency_hopper_0/amplitude_tready]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins frequency_hopper_0/s00_axi_aclk]
  ...
  assign_bd_address -offset 0xA0040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs frequency_hopper_0/S00_AXI/S00_AXI_reg] -force
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.835189",
   "Default View_TopLeft":"-338,-18",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.7.1 2023-07-26 3bc4126617 VDI=43 GEI=38 GUI=JA:21.0 TLS
#  -string -flagsOSRD
preplace port sysref_in -pg 1 -lvl 0 -x -10 -y 590 -defaultsOSRD
preplace port dac0_clk -pg 1 -lvl 0 -x -10 -y 560 -defaultsOSRD
preplace port vout00 -pg 1 -lvl 4 -x 1620 -y 620 -defaultsOSRD
preplace portBus led -pg 1 -lvl 4 -x 1620 -y 20 -defaultsOSRD
preplace portBus sw -pg 1 -lvl 0 -x -10 -y 0 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 330 -y 330 -defaultsOSRD
preplace inst usp_rf_data_converter_0 -pg 1 -lvl 3 -x 1350 -y 640 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 2 -x 850 -y 400 -defaultsOSRD
preplace inst rst_ps8_0_99M -pg 1 -lvl 1 -x 330 -y 700 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 2 -x 850 -y 130 -defaultsOSRD
preplace inst frequency_hopper_0 -pg 1 -lvl 3 -x 1350 -y 220 -defaultsOSRD
preplace netloc frequency_hopper_0_amplitude_tdata 1 2 2 1120 60 1540
preplace netloc frequency_hopper_0_amplitude_tvalid 1 2 2 1140 70 1560
preplace netloc frequency_hopper_0_led 1 3 1 1600 20n
preplace netloc frequency_hopper_0_nco_freq 1 2 2 1150 80 1580
preplace netloc frequency_hopper_0_nco_phase 1 2 2 1090 30 1590
preplace netloc frequency_hopper_0_nco_phase_rst 1 2 2 1160 90 1530
preplace netloc frequency_hopper_0_nco_update_en 1 2 2 1100 40 1550
preplace netloc frequency_hopper_0_nco_update_req 1 2 2 1110 50 1570
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 2 1 1050 170n
preplace netloc rst_ps8_0_99M_peripheral_aresetn 1 1 2 660 230 1040
preplace netloc sw_1 1 0 3 NJ 0 NJ 0 1070
preplace netloc usp_rf_data_converter_0_clk_dac0 1 1 3 680 600 1030 870 1540
preplace netloc usp_rf_data_converter_0_dac0_nco_update_busy 1 2 1 1130 230n
preplace netloc usp_rf_data_converter_0_s00_axis_tready 1 2 1 1170 210n
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 3 40 440 670 580 1080
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 2 30 430 620
preplace netloc dac0_clk_1 1 0 3 10J 570 NJ 570 NJ
preplace netloc ps8_0_axi_periph_M00_AXI 1 2 1 1070 390n
preplace netloc ps8_0_axi_periph_M01_AXI 1 2 1 1060 170n
preplace netloc sysref_in_1 1 0 3 NJ 590 NJ 590 NJ
preplace netloc usp_rf_data_converter_0_vout00 1 3 1 NJ 620
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 1 1 N 290
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM1_FPD 1 1 1 N 310
levelinfo -pg 1 -10 330 850 1350 1620
pagesize -pg 1 -db -bbox -sgen -130 -20 1730 1250
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/62410_bec/62410_bec.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu48dr-ffvg1517-2-e -flow {Vivado Synthesis 2024} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu48dr-ffvg1517-2-e -flow {Vivado Implementation 2024} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
